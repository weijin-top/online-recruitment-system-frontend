  ...
  <div class="app-container">
    ...
    <div v-if="centerDialogVisible" class="resume-box">
      <resume-preview
        ...
        :is-show-export-btn="status === 3"
        :is-show-interested-btn="status === 0"
        :is-show-interview-btn="status !== 3"
...
import { pageDelivery, modifyResumeDeliveryStatus  } from '@/api/resumeDelivery'
...
export default {
  ...
  methods: {
    ...
    visibleDialog(userId, resumeDeliveryId) {
      ...
      if(this.status === 0){
        // 未查看页面查看简历，修改状态，不对返回值做处理
        modifyResumeDeliveryStatus(resumeDeliveryId, 1)
      }
